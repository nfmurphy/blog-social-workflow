import type {
  ...
  CarouselSlide,
  ContentBrief,
  SocialWorkflowOutput,
} from './types.js';

export function recommendFormats(article: ArticleInput): ContentBrief['recommendedFormats'] {
...
export function buildContentBrief(article: ArticleInput): ContentBrief {
...
export function generateFacebookPost(article: ArticleInput): SocialWorkflowOutput['facebookPost'] {
  ...
  return {
    ...
    linkStrategy: article.url ? `Include the article link directly in the post: ${article.url}` : 'Include the article link directly in the post.',
  };
}

export function generateInstagramCaption(article: ArticleInput): SocialWorkflowOutput['instagramCaption'] {
  return {
    copy:
...
export function generateCarousel(article: ArticleInput): CarouselSlide[] {
...
export function runWorkflow(article: ArticleInput): SocialWorkflowOutput {
